...
import { HiCheckCircle, HiCloudUpload, HiX } from "react-icons/hi";
          ...
          <div className="flex p-4">
            {steps.map((item, index) => (
              <div className="flex items-center flex-1 gap-2 font-semibold">
                <div
                  className={`${
                    step == item.value ? "bg-white " : "bg-info-dark text-white"
              ...
              COMPLETE: (
                <div className="py-6">
                  <div className="flex items-center justify-center text-xl font-semibold text-gray-700">
                    <i className="mr-2 text-4xl text-success">
                      <HiCheckCircle />
                    </i>
                    Đăng ký tên miền thành công
                  </div>
                  <table className="w-5/6 py-4 mx-auto mt-8 border-l border-r border-gray-600 table-auto">
                    <thead>
    ...
    <div className="mb-4">
      ...
      {file ? (
        <div className="flex items-center bg-white border border-gray-300 rounded">
          ...
          <div className="px-2 ml-auto text-sm text-gray-500 border-r border-gray-300">
