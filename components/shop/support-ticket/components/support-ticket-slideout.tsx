        ...
        <div className="h-screen overflow-y-scroll v-scrollbar">
          <div className="flex flex-col p-6">
            ...
            >
              ...
              <Form.Footer cancelText="" submitText="Bình luận" />
            </Form>
          </div>
        </div>
      )}
    ...
    <div className="w-full overflow-hidden">
      <div className="flex gap-x-4 mt-2">
        ...
        <div className="">
          ...
          <div className="text-xs">{`vào lúc ${
            comment?.createdAt && formatDate(comment?.createdAt, "hh:mm dd/MM/yyyy")
          }`}</div>
