  ...
  return (
    <>
      <div className={`col-span-6 grid grid-cols-12 gap-x-5 auto-rows-min`}>
        ...
        <Field name="minItemQty" label="Tổng số sản phẩm tối thiểu" cols={6}>
          <Input number suffix="sản phẩm" />
        </Field>
      ...
      <div className="flex">
        ...
        <div className="flex flex-1 ml-4">
          ...
          <i
            ...
            data-tooltip="Đồng giá sẽ áp dụng cho tất cả sản phẩm có giá cao hơn mức đồng giá. Trường hợp giá tương dương hoặc thấp hơn thì sẽ không phát sinh đồng giá"
          >
            <FaInfoCircle />
          </i>
        </div>
              ...
              {samePrice !== undefined ? (
                <span className="text-danger">
                  ...
                  <span className="pl-1 text-sm font-normal text-gray-600">
                    (tối đa {(item as OfferItem).qty} sản phẩm)
                  </span>
                </span>
              ) : (
