...
export const HomeContext = createContext<
  Partial<{
    ...
    customerLogin: (phone: string) => any;
    customerLogout: Function;
    customerLoginOTP: (phone: string, name: string, otp: string) => any;
  }>
>({});
...
export function HomeProvider({ ...props }) {
  ...
  const CUSTOMER_LOGIN_PATHNAME = "customer-login-pathname";
  ...
  }, [userLocation, selectedCategory, search, listMode]);
