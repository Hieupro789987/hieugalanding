...
export function ShopDetailsReactions(props: Propstype) {
  ...
  return (
    <div className="relative pb-3 bg-white border-b group">
      <Swiper
        spaceBetween={10}
        freeMode={true}
        grabCursor
      ...
      >
        {props.reactions.map((item, index) => (
          <SwiperSlide key={item.name} className="w-auto">
            <div
              className="flex rounded-full items-center p-1.5 px-2 border border-gray-400 text-sm shadow-sm bg-white"
