      ...
      {threadOrderCrud.items ? (
        <div className="flex flex-col gap-3 p-3">
          ...
          {threadOrderCrud.items.length < threadOrderCrud.pagination.total && (
            <Button outline text={"Xem thêm"} onClick={threadOrderCrud.loadMore} />
          )}
          <OrderDetailsDialog
            orderId={orderId}
            isOpen={!!orderId}
      ...
      {ticketCrud.items ? (
        <div className="flex flex-col gap-3 p-3">
          ...
          {ticketCrud.items.length < ticketCrud.pagination.total && (
            <Button outline text={"Xem thêm"} onClick={ticketCrud.loadMore} />
          )}
