...
export function VoucherItem({
  ...
  return (
    <div
      className={`flex items-center w-full h-20 border-t border-b border-gray-300 relative ${className}`}
    >
      <div
      ...
      >
        <Img lazyload={false} className="w-20 border-l-4 border-primary" src={voucher.image} />
        <div className="flex flex-col flex-1 py-2 pl-2 text-ellipsis-1">
